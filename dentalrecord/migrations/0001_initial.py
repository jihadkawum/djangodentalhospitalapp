    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('registration_no', models.CharField(auto_created=True, default=dentalrecord.utils.create_new_ref_number, editable=False, max_length=6, null=True, unique=True)),
                ...
                ('gender', models.CharField(blank=True, choices=[('Male', 'Male'), ('Female', 'Female'), ('Transgender', 'Transgender')], default='', max_length=100, null=True)),
